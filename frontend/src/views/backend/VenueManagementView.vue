    ...
    <section class="grid gap-6 xl:grid-cols-[0.6fr,1fr]">
      <div class="space-y-4">
        <div class="flex flex-wrap gap-3">
          <FormField legend="关键词搜索" fieldsetClass="grow min-w-[14rem]">
          ...
          <FormField legend="状态筛选" fieldsetClass="w-40">
          ...
          >
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="flex flex-wrap gap-2">
                <button class="btn" @click.stop="handleDisplayBoard(committee, 'preview')">
                  预览大屏
                </button>
              </div>
            </div>
      ...
      <div v-if="selectedCommittee" class="space-y-4">
        ...
        <section class="border border-base-200 rounded-2xl p-4 space-y-3">
          ...
          <div class="space-y-3">
            ...
            <FormField legend="时间流速" fieldsetClass="w-full">
  ...
  <dialog :open="showDaisModal" class="modal">
    <div class="modal-box max-w-2xl">
      ...
      <div class="modal-action">
        <button class="btn" @click="cancelDaisSelection">取消</button>
