          ...
          <div class="space-y-3">
            ...
            <FormField legend="时间流速" label="选择或自定义流速" fieldsetClass="w-full">
              <div class="flex gap-2 items-center flex-wrap">
                <div class="join">
                  <button type="button" class="btn btn-outline btn-primary join-item w-16"
                    :class="{ 'btn-active': timeForm.flowSpeed === 3 }" @click="timeForm.flowSpeed = 3">
                    3x
                  </button>
                  <button type="button" class="btn btn-outline btn-primary join-item w-16"
                    :class="{ 'btn-active': timeForm.flowSpeed === 60 }" @click="timeForm.flowSpeed = 60">
                    60x
                  </button>
                  <button type="button" class="btn btn-outline btn-primary join-item w-16"
                    :class="{ 'btn-active': timeForm.flowSpeed === 180 }" @click="timeForm.flowSpeed = 180">
                    180x
                  </button>
                </div>
