...
const featureGroups: FeatureGroup[] = [
  ...
  },
  {
    ...
    items: [
      {
        label: '文件审批',
        description: '查看与审批代表提交',
        to: '/backend/presidium/file-approval',
      },
      {
        label: '文件管理',
        description: '发布、分类、可见性',
        to: '/backend/presidium/file-management',
      },
  ...
  },
  {
    ...
    items: [
      {
        label: '会场中心',
        description: '上传与查看文件、危机管理',
        to: '/backend/delegate/documents',
      },
    ...
    <section class="grid gap-6 lg:grid-cols-[15rem,1fr]">
      ...
      >
        ...
        <div class="space-y-6 overflow-y-auto pr-2 flex-1">
          ...
          <div
            v-else-if="filteredFeatureGroups.length === 0"
          ...
          >
            ...
            <ul class="menu menu-vertical gap-2">
              <li v-for="item in group.items" :key="item.to">
                <RouterLink
                  :to="item.to"
                  class="justify-start gap-3 rounded-lg w-100vw"
