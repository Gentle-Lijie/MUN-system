          ...
          <div class="flex items-center gap-2">
            <div v-if="isLoggedIn" class="dropdown dropdown-end">
              ...
              <ul tabindex="0"
                ...
                <li>
                  <button class="btn btn-ghost justify-start" @click="handleChangePassword">修改密码</button>
                </li>
                <li><button class="btn btn-ghost justify-start text-error" @click="handleLogout">退出登录</button></li>
              </ul>
            </div>
            <button v-else class="btn btn-ghost btn-circle" @click="openLoginModal" aria-label="登录">
            ...
            <button class="btn btn-ghost btn-circle" @click="toggleTheme" aria-label="切换主题">
    ...
    <div class="modal-box space-y-4">
      ...
      <form class="space-y-4" @submit.prevent="handleLogin">
        ...
        <div class="modal-action">
          <button type="button" class="btn btn-ghost min-w-[4rem]" @click="closeLoginModal">取消</button>
